...
namespace al {
    ...
    void
    lerpVecHV(sead::Vector3f *, sead::Vector3f const &, sead::Vector3f const &, sead::Vector3f const &, float, float);
    ...
    void hermiteVec(sead::Vector3f *, sead::Vector3f const &, sead::Vector3f const &, sead::Vector3f const &,
    ...
    void calcEyesAnimAngleInRange(float *, sead::Vector3f const &, sead::Vector3f const &, sead::Vector3f const &,
                                  sead::Vector3f const &, float, float, float, float);
